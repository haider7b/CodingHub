...
function TeamAssisCard({ name, image, title, description ,socialLinks}) {

    return (
        <div className="team-card w-1/3 bg-white flex flex-col lg:flex-row items-center lg:h-[200px] md:h-[500px] h-fit  
            overflow-hidden gap-0 lg:gap-8  p-4">
                {
                    image.includes("haider")?(//if it's person img
                ...
                (<div className="bg-red- 300 w-[80px] h-full flex justify-center">
